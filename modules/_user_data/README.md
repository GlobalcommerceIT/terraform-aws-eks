...
Configuration in this directory renders the appropriate user data for the given inputs. See [`docs/user_data.md`](https://github.com/xepelinapp/terraform-aws-eks-v2/blob/master/docs/user_data.md) for more info.

See [`examples/user_data/`](https://github.com/xepelinapp/terraform-aws-eks-v2/tree/master/examples/user_data) for various examples using this module.
