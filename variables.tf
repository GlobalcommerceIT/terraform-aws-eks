...
variable "argocd_addon" {
  description = "Flag to wether install or not argocd on the cluster"
  default     = false
}
...
variable "aws_load_balancer_controller_chart_version" {
  description = "Version of the helm chart of aws-load-balancer-controller to install"
  default = ""
}
...
variable "external_dns_addon" {
  description = "Flag to wether install or not external-dns on the cluster"
  default     = false
}
variable "external_dns_chart_version" {
  description = "Version of the helm chart of External-DNS to install"
  default = ""
}
variable "external_dns_domains" {
  description = "Domains to filter in external-dns addon"
  type = list(string)
  default = [""]
}
...
variable "external_secrets_addon" {
  description = "Flag to wether install or not external-secrets on the cluster"
  default     = false
}
variable "external_secrets_chart_version" {
  description = "Version of the helm chart of external-secrets to install"
  default = ""
}
...
variable "external_secrets_secrets_manager_arns" {
  type = list(string)
  description = "List of secrets manager ARNs to modify."
  default = [""]
}
variable "external_secrets_ssm_parameter_arns" {
  description = "List of parameter store ARNs to modify."
  type = list(string)
  default = [""]
}
variable "falco_addon" {
  description = "Flag to wether install or not falco on the cluster"
  default     = false
}
variable "falco_chart_version" {
  description = "Version of the helm chart of falco to install"
  default = ""
}
 variable "keda_addon" {
  description = "Flag to wether install or not keda on the cluster"
  default     = false
}
variable "keda_chart_version" {
  description = "Version of the helm chart of keda to install"
  default = ""
}
variable "kubecost_addon" {
  description = "Flag to wether install or not kubecost on the cluster"
  default     = false
}
variable "kube_prometheus_addon" {
  description = "Flag to wether install or not kube-prometheus on the cluster"
  default     = false
}
variable "kube_prometheus_chart_version" {
  description = "Version of the helm chart of kube-prometheus to install"
  default = ""
}
 variable "metrics_server_addon" {
  description = "Flag to wether install or not metrics-server on the cluster"
  default     = false
}
