...
## [Documentation](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/blob/master/docs)

- [Frequently Asked Questions](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/blob/master/docs/faq.md)
- [Compute Resources](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/blob/master/docs/compute_resources.md)
- [IRSA Integration](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/blob/master/docs/irsa_integration.md)
- [User Data](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/blob/master/docs/user_data.md)
- [Network Connectivity](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/blob/master/docs/network_connectivity.md)
- Upgrade Guides
  - [Upgrade to v17.x](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/blob/master/docs/UPGRADE-17.0.md)
  - [Upgrade to v18.x](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/blob/master/docs/UPGRADE-18.0.md)
  - [Upgrade to v19.x](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/blob/master/docs/UPGRADE-19.0.md)
...
- [Complete](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/tree/master/examples/complete): EKS Cluster using all available node group types in various combinations demonstrating many of the supported features and configurations
- [EKS Managed Node Group](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/tree/master/examples/eks_managed_node_group): EKS Cluster using EKS managed node groups
- [Fargate Profile](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/tree/master/examples/fargate_profile): EKS cluster using [Fargate Profiles](https://docs.aws.amazon.com/eks/latest/userguide/fargate.html)
- [Karpenter](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/tree/master/examples/karpenter): EKS Cluster with [Karpenter](https://karpenter.sh/) provisioned for intelligent data plane management
- [Outposts](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/tree/master/examples/outposts): EKS local cluster provisioned on [AWS Outposts](https://docs.aws.amazon.com/eks/latest/userguide/eks-outposts.html)
- [Self Managed Node Group](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/tree/master/examples/self_managed_node_group): EKS Cluster using self-managed node groups
- [User Data](https://bitbucket.org/vtr-internal-apps/terraform-aws-eks-v2/tree/master/examples/user_data): Various supported methods of providing necessary bootstrap scripts and configuration settings via user data
